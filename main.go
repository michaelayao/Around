...
const (
	POST_INDEX = "post"
	DISTANCE   = "200km" //Search radius

	ES_URL      = "http://10.128.0.2:9200"
	BUCKET_NAME = "around-storage"
)

//Hashmap indicating image or video for frontend
var (
...
func handlerSearch(w http.ResponseWriter, r *http.Request) {
	...
	//Return posts in response body(post -> json)
...
func handlerCluster(w http.ResponseWriter, r *http.Request) {
	...
	//Not only can detect face(term in general)
	...
	//Return cluster in response body
	js, err := json.Marshal(posts)
	if err != nil {
...
func saveToGCS(r io.Reader, objectName string) (*storage.ObjectAttrs, error) {
	...
	//Open read only access to all users
